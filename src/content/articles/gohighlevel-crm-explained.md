...
faqs:
  - question: "Is GoHighLevel a good CRM?"
    answer: "GoHighLevel is an excellent CRM for marketing agencies and small-to-mid-sized businesses. It combines contact management with built-in communication (email, SMS, calls), pipeline management, and marketing automation — all in one platform. It's not as feature-rich as enterprise CRMs like Salesforce, but for most agency use cases it's more than enough."
  - question: "How many contacts can GoHighLevel hold?"
    answer: "GoHighLevel supports unlimited contacts on all plans. There is no per-contact pricing or storage limit for contacts."
  - question: "Can GoHighLevel replace HubSpot?"
    answer: "For most agencies and SMBs, yes. GoHighLevel replaces HubSpot's core CRM, email marketing, and pipeline management features at a significantly lower price. HubSpot has advantages in reporting depth and enterprise integrations, but GHL's automation and multi-client features are superior for agencies."
  - question: "Does GoHighLevel have lead scoring?"
    answer: "GoHighLevel does not have built-in lead scoring in the traditional sense, but you can replicate lead scoring behavior using tags, custom fields, and conditional workflow logic to segment and prioritize leads based on their actions."
  - question: "How does the GoHighLevel conversation inbox work?"
    answer: "The GoHighLevel conversations inbox is a unified messaging center that shows all communication with a contact — email, SMS, Facebook Messenger, Instagram DMs, Google Business Messages, and call recordings — in one chronological feed."
---
...
- **Source tags:** `fb-ad`, `google-lead`, `referral`, `organic`
- **Status tags:** `new-lead`, `qualified`, `proposal-sent`, `closed`
- **Service tags:** `service-seo`, `service-ads`, `service-web`
- **Behavior tags:** `opened-email`, `clicked-link`, `booked-appointment`
...
1. **Standardize your tag taxonomy early** — inconsistent tags lead to messy segmentation
2. **Use custom fields** for data that matters to your business (lead score, niche, budget range)
3. **Set up pipeline automation** so deal stage changes trigger next steps automatically
4. **Use Smart Lists** instead of manually building campaigns for each segment
5. **Review your Conversations inbox daily** — it keeps you on top of every open conversation
